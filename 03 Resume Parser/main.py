from All_schemas_and_classes import jobd_schema, JobD
from Api_function import API_CALL
import json
from pathlib import Path
from all_functions import read_resume, parse_resume, final_score
import time 
import os
...
raw_json_response = API_CALL(user_prompt ,system_prompt)

ans = json.loads(raw_json_response)
...
resume_folder = Path("03 Resume Parser/resumes")
all_results = []
...
for file_path in resume_folder.iterdir():
    ...
    match_result = final_score(job=job, resume=parsed_resume)
    time.sleep(5)
